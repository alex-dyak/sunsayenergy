	...
	<section class="project-section">
		<div class="container">
			<div class="project-list">
                ...
                <?php else : ?>
					<div class="project-list-item" data-order="<?= $item->project_order ?>">
						<a href="<?= \yii\helpers\Url::to(['project/detailed', 'symbol' => $item->symbol]) ?>" style="background-image: url('/img/logo.svg')" class="background-lazy" data-src="<?= $item->getFirstImg(550) ?>">
							<div class="project-list-title"><strong><?= $item->header ?></strong></div>
						</a>
					</div>
                <?php endif; ?>
