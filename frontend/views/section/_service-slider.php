		...
		<div class="service-types-wrap">
			...
			<div class="service-types-slider">
				<div class="service-slide">
					...
					<div class="image background-lazy" style="background-image: url('get_image.php?img=img/loader.gif')" data-src='get_image.php?img=img/services/service-1.jpg'></div>
				</div>
				<div class="service-slide">
					<div class="text-wrap">
						<p class="text"><?= BaseController::getMessage('278') ?></p>
					</div>
					<div class="image background-lazy" style="background-image: url('get_image.php?img=img/loader.gif')" data-src='get_image.php?img=img/services/service-2.jpg'></div>
				</div>
				<div class="service-slide">
					<div class="text-wrap">
						<p class="text"><?= BaseController::getMessage('280') ?></p>
					</div>
					<div class="image background-lazy" style="background-image: url('get_image.php?img=img/loader.gif')" data-src='get_image.php?img=img/services/service-3.jpg'></div>
				</div>
			</div>
		</div>
	</div>
