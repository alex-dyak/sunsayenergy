...
<main class="page-container">
	...
	<section class="about-hero-section" style="background-image: url('/img/about/hero-img-about.jpg')">
	...
	<section class="our-steps-section">
		<div class="container">
			...
			<ol class="steps-list">
				<li>
					<div class="img-part background-lazy" style="background-image: url('/img/logo.svg')" data-src="/img/about/step-1.jpg"></div>
				...
				<li>
					<div class="img-part background-lazy" style="background-image: url('/img/logo.svg')" data-src="/img/about/step-2.jpg"></div>
					<div class="yellow-part">
						<div class="text-wrap">
				...
				<li>
					<div class="img-part background-lazy" style="background-image: url('/img/logo.svg')" data-src="/img/about/step-3.jpg"></div>
					<div class="yellow-part">
						<div class="text-wrap">
				...
				<li>
					<div class="img-part background-lazy" style="background-image: url('/img/logo.svg')" data-src="/img/about/step-4.jpg"></div>
					<div class="yellow-part">
						<div class="text-wrap">
	...
	<section class="green-payment">
		<div class="container">
			<ul class="green-payment-list">
				<li class="green-payment-item background-lazy" style="background-image: url('/img/logo.svg')" data-src="/img/commercial-station/warranty.jpg"></li>
