                ...
                <ul class="possibility-list-slider">
                        ...
                        <li class="possibility-item">
                            <div class="possibility-item-inner">
                                <div class="possibility-img">
                                    <img oncontextmenu="return false" data-src="/img/homepage/investments.svg" alt="<?= BaseController::getMessage('431') ?>">
                                </div>
                    ...
                    <div class="possibility-item-slider">
                        <li class="possibility-item">
                            <div class="possibility-item-inner">
                                <div class="possibility-img">
                                    <img oncontextmenu="return false" data-src="/img/homepage/profit.svg" alt="<?= BaseController::getMessage('433') ?>">
                                </div>
                    ...
                    <div class="possibility-item-slider">
                        <li class="possibility-item">
                            <div class="possibility-item-inner">
                                <div class="possibility-img">
                                    <img oncontextmenu="return false" data-src="/img/homepage/voltage.svg" alt="<?= BaseController::getMessage('435') ?>">
                                </div>
                    ...
                    <div class="possibility-item-slider">
                        <li class="possibility-item">
                            <div class="possibility-item-inner">
                                <div class="possibility-img">
                                    <img oncontextmenu="return false" data-src="/img/homepage/status.svg" alt="<?= BaseController::getMessage('437') ?>">
                                </div>
...
<!-- <section class="pros-section">
    <div class="container">
        ...
        <ul class="pros-list pros-list-slider">
            <li>
				<div class="img-round">
