...
<header class="header <?= (Yii::$app->controller->route == 'site/index') ? '' : 'header__background' ?>">
	...
	<div class="header__mobile-top-block">
		<div class="mobile-contact">
			...
			<ul class="mobile-contact-list">
				...
				<li><a class="binct-phone-number-2" href="tel:<?= $contacts->mobile_1; ?>"><?= $contacts->mobile_1; ?></a></li>
				<li><a class="binct-phone-number-3" href="tel:<?= $contacts->mobile_2; ?>"><?= $contacts->mobile_2; ?></a></li>
			</ul>
		</div>
		<div id="nav-icon">
			<span>Меню</span>
    ...
    <div class="navbar-mobile">
        <div class="navbar-mobile-container">
            ...
            <div class="menu__content-map__address">
                <div class="menu__content-map__address-content">
...
<div id="to_top_block" class="to-top-block">
	<div class="logo-block">
		<a href="<?= \yii\helpers\Url::to(['/']); ?>"><img class="img-responsive" data-src="/img/logo.svg" alt="sunsay energy" width="120"></a>
	</div>
	<a href="#" id="to-top-link"><img class="img-responsive" data-src="/img/icon/arrow-top.svg" alt="to top"></a>
</div>
<?= $content ?>
