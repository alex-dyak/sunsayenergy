		...
		<div class="header-wrap">
			...
			<div class="header__logotype">
				<a href="<?= \yii\helpers\Url::to(['/']); ?>">
					<img class="img-responsive" src="/img/logo.svg" width="184" alt="sunsay energy">
					<strong class="logo-text">Сонячні електростанції</strong>
				</a>
			</div>
			<div class="header__navbar">
				<div class="navbar-list-top">
					<div class="navbar-logotype"><a href="<?= \yii\helpers\Url::to(['/']); ?>"><img src="/img/logo.svg" width="140" alt=""></a></div>
					<div class="navbar-close"><img data-src="/img/icon/Close.svg" width="20" alt=""></div>
				</div>
				<nav class="navbar">
					<ul class="navbar__list">
						<li class="navbar__list-item-block">
							...
							<ul class="navbar__list-item-dropdown" data-dropdown="services">
								<li>
									<a href="<?= \yii\helpers\Url::to(['/solar-power-station-for-income']) ?>"
									   class="<?= (Yii::$app->controller->route == 'site/income') ? 'active-menu' : ''; ?>">
										<span><span><?= BaseController::getMessage('2') ?></span></span>
									</a>
								</li>
								<li>
									<a href="<?= \yii\helpers\Url::to(['/solar-power-for-backup-power']); ?>"
									   class="<?= (Yii::$app->controller->route == 'site/reserve') ? 'active-menu' : ''; ?>">
										<span><span><?= BaseController::getMessage('3') ?></span></span>
									</a>
								</li>
								<li>
									<a href="<?= \yii\helpers\Url::to(['/solar-power-for-autonomous-power']); ?>"
									   class="<?= (Yii::$app->controller->route == 'site/comfort') ? 'active-menu' : ''; ?>">
										<span><span><?= BaseController::getMessage('4') ?></span></span>
									</a>
								</li>
							</ul>
						</li>
						...
						<li>
							<a class="navbar__list-item <?= (Yii::$app->controller->route == 'site/green') ? 'active-menu' : ''; ?>"
							   href="<?= \yii\helpers\Url::to(['/green-tariff']); ?>"><span><?= BaseController::getMessage('5') ?></span></a></li>
						<li>
						...
						<li>
							<a class="navbar__list-item" href="#contact"><span><?= BaseController::getMessage('8') ?></span></a>
						</li>
				...
				<div class="header__request">
					...
					<a class="request-btn" href="#"><span><?= BaseController::getMessage('9') ?></span></a>
