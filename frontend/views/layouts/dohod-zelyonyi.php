				...
				<nav class="header-nav">
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="<?= (Yii::$app->controller->route == 'site/reserve') ? 'active' : ''; ?>">
                            <a class="hidden-mobile nav-link" href="<?= \yii\helpers\Url::to(['/solar-power-for-backup-power']); ?>"><?= BaseController::getMessage('897') ?></a>
                            <a class="visible-mobile nav-link" href="<?= \yii\helpers\Url::to(['/solar-power-for-backup-power']); ?>"><?= BaseController::getMessage('898') ?></a>
                        </li>
                    ...
                    <ul>
                        <li class="<?= (Yii::$app->controller->route == 'site/commercial') ? 'active' : ''; ?>">
                            <a href="<?= \yii\helpers\Url::to(['/commercial_stations']); ?>">
                                <span><?= BaseController::getMessage('531') ?></span>
                            </a>
                        </li>
                        <li class="<?= (Yii::$app->controller->route == 'site/reserve') ? 'active' : ''; ?>">
