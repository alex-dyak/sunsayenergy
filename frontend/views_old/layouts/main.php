...
<header class="header <?= (Yii::$app->controller->route == 'site/index') ? '' : 'header__background' ?>">
    ...
    <div class="header__request">
        ...
        <div class="request-close"><img class="close" data-src="/img/icon/Close.svg" alt=""></div>
    </div>
    <div class="header-request-back"><img data-src="/img/icon/arrow-back.png" alt=""></div>
    <div class="header__button">
        <div id="nav-icon"><img data-src="/img/icon/Menu.svg" alt=""></div>
    </div>
...
<script type="text/javascript">
    deferstyle('https://fonts.googleapis.com/css?family=Montserrat:400,500');
</script>
...
<script type="deferjs" src="https://osvaldas.info/examples/lazy-loading-google-maps/jquery.lazy-load-google-maps.min.js"></script> -->
