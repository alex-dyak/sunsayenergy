...
window.googleMapsScriptLoaded=function(){$(window).trigger("googleMapsScriptLoaded")},function(a,i){"use strict";var e=a(i),t=a("body"),r=e.height(),s=0,n=function(n,o){var a=null;return function(){var i=this,e=arguments;clearTimeout(a),a=setTimeout(function(){o.apply(i,e)},n)}},o=function(o,a){var t,r;return function(){var i=this,e=arguments,n=+new Date;t&&n<t+o?(clearTimeout(r),r=setTimeout(function(){t=n,a.apply(i,e)},o)):(t=n,a.apply(i,e))}},c=!1,l=!1,g=a([]),p=function(){s=e.scrollTop(),g.each(function(){var i=a(this),e=i.data("options");if(i.offset().top-s>1*r)return!0;if(!c&&!l){var n={callback:"googleMapsScriptLoaded",signed_in:e.signed_in};e.key&&(n.key=e.key),e.libraries&&(n.libraries=e.libraries),e.language&&(n.language=e.language),e.region&&(n.region=e.region),t.append('<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&'+a.param(n)+'"><\/script>'),l=!0}if(!c)return!0;var o=new google.maps.Map(this,{zoom:15});!1!==e.callback&&e.callback(this,o),g=g.not(i)})};e.on("googleMapsScriptLoaded",function(){c=!0,p()}).on("scroll",o(500,p)).on("resize",n(1e3,function(){r=e.height(),p()})),a.fn.lazyLoadGoogleMaps=function(e){return e=a.extend({key:!1,libraries:!1,signed_in:!1,language:!1,region:!1,callback:!1},e),this.each(function(){var i=a(this);i.data("options",e),g=g.add(i)}),p(),this.debounce=n,this.throttle=o,this}}(jQuery,window,document);
